...
import 'package:hcbe_alerts/models/distress_message.dart';
...
class Alerts {
  ...
  ///
  static updateAlertMessages(
    String message,
    String alertId,
    String userId,
  ) async {
    DistressMessage sendToDB = DistressMessage(
      uid: userId,
      distressId: alertId,
      message: message,
    );
    Firestore.instance.collection("alertMessages").add(sendToDB.toJson()).then(
      (docRef) async {
        Firestore.instance
